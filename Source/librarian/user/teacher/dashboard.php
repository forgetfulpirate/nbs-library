                ...
                <div class="col-md-12 mb-3 d-flex flex-wrap">
                    ...
                    <?php endif; ?> -->
                            ...
                            <?php if (!empty($highlightedCall_Number)): ?>
                                <p class="card-text" style="letter-spacing:1px; margin-left:20px ; margin-bottom:5px; font-weight:bold">Call Number: <span style='font-weight:100;'><?php echo $highlightedCall_number_type;
                                                                                                                                                                                    echo " ";
                                                                                                                                                                                    echo $highlightedCall_Number ?><span></p>
                            <?php endif; ?>
...
<script>
    ...
    document.querySelectorAll('.sort-option').forEach(item => {
        item.addEventListener('click', event => {
            ...
            let sortValue = item.getAttribute('data-sort');
