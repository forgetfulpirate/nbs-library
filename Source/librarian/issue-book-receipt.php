...
class PDF extends FPDF
{
    ...
    function Footer()
    {
        ...
        $this->Image('inc/img/NBS-LOGO.png', $startX, $this->GetY(), $imageWidth, 20, 'PNG');

        // Set the font for the footer text
        $this->SetFont('Arial', '', 8);

        // Add the text next to the image
        $this->SetXY($startX + $imageWidth + 0, $this->GetY() + 5); // Adjust the Y position to align with the image
        $this->MultiCell(90, 3, "3rd & 4th floors, Sct. Borromeo corner Quezon Avenue, Diliman, Lungsod Quezon, Kalakhang Maynila\nPhone: (02) 8376 5090\nlibrary@nbscollege.edu.ph", 0, 'L');
    }
}
